...
class Tela {
    static obterCodigoHtml(item){
        return `
        <div class="col-md-3">
        <div class="card" style="width: 10rem;" onclick="window.verificarSelecao('${item.id}','${item.nome}')">
    ...
    static exibirHerois(nomeDoHeroi, img) {
        ...
        // para cada elemento encontrado ne tela, vamos alterar a imagem
        // para a imagem inicial dele
        // com o forEach, par cada item, dentro dos () setamos o valor
        // de imagem
    ...
    static iniciarContador(){
        ...
        // essa funcao vai substituir o $$contador pelo `contarAte` diminuindo
