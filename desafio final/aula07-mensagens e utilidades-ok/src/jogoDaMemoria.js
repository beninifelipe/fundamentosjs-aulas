class JogoDaMemoria {
    ...
    constructor ({ tela, util }) {
        ...
        // ao index.html!
        this.heroisIniciais = [
            { img: './arquivos/antman.png', nome: 'antman'},
            { img: './arquivos/capitainamerica.png', nome: 'capitainamerica'},
    ...
    // para usar o this, não podemos usar o static!
     ...
     exibirHerois(nomeDoHeroi) {
         // vamos procurar esse horoi pelo nome em nossos heroisIniciais
         // vamos obter somente a imagem dele 
         const { img } = this.heroisIniciais.find(({ nome })  => nomeDoHeroi === nome) 
         // vamos criar a funcao na tela, para exibir na tela somente o heroi selecionado
     ...
     verificarSelecao(id, nome) {
         ...
         // e tomar ação se escolheu errado ou não
         ...
         switch(heroisSelecionados) {
             case 0:
                ...
                // zerar itens para nao selecionar mais dois 
                this.heroisSelecionados = []
